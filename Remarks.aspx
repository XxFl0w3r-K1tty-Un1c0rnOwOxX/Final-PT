<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Remarks.aspx.cs" Inherits="WebApplication1.Remarks" %>
    ...
    <div>
        <asp:Panel ID="one" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                DataKeyNames="Appointment Code" DataSourceID="SqlDataSource4" 
                Height="25px" onselectedindexchanged="GridView1_SelectedIndexChanged" 
                Width="749px">
                <Columns>
        ...
        <table>
        <tr> <td> Appointment Code: </td>
        <td> 
            <asp:DropDownList ID="drpCode" runat="server" 
                DataSourceID="SqlDataSource2" DataTextField="Appointment_Code" 
                DataValueField="Appointment_Code">
            </asp:DropDownList>
        ...
        <tr> <td> Remarks:</td>
        <td> 
            <asp:TextBox ID="txtRemarks" runat="server"></asp:TextBox></td> </tr>
            <tr> <td>
                <asp:Button ID="btnAdd" runat="server" Text="Add Remarks" 
                    onclick="btnAdd_Click" /> </td></tr>
        </table>
        </asp:Panel>
